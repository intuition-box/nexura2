...
export default function EcosystemDapps() {
  ...
  const dapps: Dapp[] = [
    ...
    },
    {
      ...
      isCompleted: false,
      isClaimed: false,
      websiteUrl: "https://dice.intuition.game"
    },
    {
      ...
      isCompleted: false,
      isClaimed: false,
      websiteUrl: "https://trustname.app"
    },
    ...
    },
    {
      ...
      isCompleted: false,
      isClaimed: false,
      websiteUrl: "https://gazebreaker.game"
    },
    {
      id: "intuitpark",
      name: "IntuitPark",
    ...
    },
    {
      ...
      isCompleted: false,
      isClaimed: false,
      websiteUrl: "https://meme.intuition.systems"
    },
    {
      id: "intuition-bets",
      name: "Intuition BETs",
                ...
                <div className="flex items-center space-x-3">
                  <div className="w-12 h-12 flex items-center justify-center">
                    {typeof dapp.logo === 'string' && dapp.logo.startsWith('/') ? (
                      <img src={dapp.logo} alt={dapp.name} className="w-8 h-8 object-contain" />
                    ) : (
                      <img src={dapp.logo} alt={dapp.name} className="w-8 h-8 object-contain" />
                    )}
                  </div>
